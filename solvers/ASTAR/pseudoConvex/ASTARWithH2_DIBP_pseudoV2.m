...
function [pk,vk,nodeNumber,uniqueNodeNumber, hInit, ubInit, levelMax,NOPruned, NODIBP] = ASTARWithH2_DIBP_pseudoV2(A,b,c,d, x0, th, refine, BFSStart, runtimeLimit)
...
while numel(q)>0
    ...
    %% DIBP
    [childPoolTmp, bRest, bsPoolTmp, NOPruned, NODIBP,  q, priof, priow, dictS, dictB, pk, vk, minOUT, returnFlag] = DIBP_Pseudo_V2(A,b,c,d,dim1,acc,th, pk, vk, minOUT,node, q, priof, priow, dictS, dictB, NOPruned, NODIBP, N, 0);
